...
## Jamais public (sectoriel, non négociable)
- Données de clients, prospects, acquéreurs, locataires : noms, situations, budgets, adresses, échanges.
- Prix négociés, remises individuelles, marges, conditions commerciales internes.
- Contrats, actes, documents juridiques, échanges avec notaires, banques, promoteurs partenaires.
- Litiges, réclamations, retards de chantier non communiqués officiellement.
- Promesses de rendement, de plus-value, de « placement sans risque ».
...
- Citer un partenaire (promoteur, banque, courtier, notaire) : accord du partenaire conservé par l'équipe.
...
## Image d'IMMO9
- Logo et charte : uniquement les fichiers de `doctrine/BRAND_SYSTEM.md` et du dossier de charte fourni par l'équipe.
- Visuels de programmes : uniquement les perspectives et photos fournies par l'équipe, avec leurs mentions.
- Visuels générés : illustrations et ambiances, jamais présentées comme des photos de programmes réels.
...
- Aucune citation non vérifiée n'est présentée comme un fait.
- Aucune statistique sans source vérifiable et datée.
- Aucune urgence artificielle, aucun appât à engagement.
- Une provenance inconnue bloque la pièce.
